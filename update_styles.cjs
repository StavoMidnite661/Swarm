...
content = content.replace(/bg-zinc-950/g, 'bg-black/40');
content = content.replace(/bg-zinc-900/g, 'bg-black/30');

// Additional adjustments for glassmorphism
content = content.replace(/border-white\/5/g, 'border-white/[0.08]');
